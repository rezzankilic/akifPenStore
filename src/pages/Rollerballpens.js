...
export default function Rollerballpens() {
    const [title, setTitle] = useState();
    const [selectedOptionId, setSelectedOptionId] = useState('2')
    ...
    const filteredArray = newArray.filter(item => item.description.includes("Rollerball"))
  ...
  return (
    <>
    <BreadCrumb page='Pens' productType='Rollerball Pens' />
    ...
    <div>
        <ProductList newArray={filteredArray} heading='Rollerball Pens'/>
    </div>
    </>
  )
}
